...
def plot_matrix(args, column_order=None):
    ...
    if args.type == 'dist':
        ...
        lines_protocols = lines + '/' + protocols
        ...
        for line_protocol in args.lines_protocols:
            line_idx = np.argwhere(lines_protocols == line_protocol)
            print(lines_protocols[line_idx], line_protocol)
            print(line_idx)
            plt.figure()
            ...
            plt.scatter(umap[line_idx,0], umap[line_idx,1], marker='D', c='r')

            plt.axis('equal')
            plt.axis('off')
            plt.savefig(f"/home/alexandre/Insync/blanc.alexandre.perso@gmail.com/Google Drive - Shared with me/figures-papier-larva-technique/figure8/figure_8_cluster_{line_protocol.split('/')[0]}.pdf")
            plt.show()
            plt.close()
...
if __name__ == '__main__':
    ...
    args.lines_protocols = ['FCF_attP2_1500062@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_68B06_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_57F07_AD_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_44G02_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_61A01_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_85F12_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_19E12_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_54G08_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_18A10_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100',
                            'GMR_38H09_AE_01@UAS_TNT_2_0003/p_8_45s1x30s0s#p_8_105s10x2s10s#n#n@100']
